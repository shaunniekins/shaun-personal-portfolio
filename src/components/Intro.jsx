...
const Intro = () => {
  ...
  return (
    <div className="bg-slate-500 pt-10 min-h-10vh md:min-h-90vh">
      <Header />
      <div
        id="intro"
        className="flex flex-col py-48 md:flex-row justify-start items-center">
        <div className="flex flex-col items-center md:items-end md:flex-row">
          ...
          <div className="text-intro text-center md:text-left md:self-center">
            ...
            <h3 className="text-base md:text-2xl">Front-end Developer</h3>
            <div className="flex flex-wrap justify-center md:justify-start mt-4 md:mt-0">
              <button
                ref={contactButtonRef}
                className="px-3 py-2 border-2 border-stone-200 rounded-md hover:scale-110 bg-gray-200 text-black transition duration-300 ease-out hover:ease-in"
                onClick={() => {
                  setShowModal(true);
                }}>
              ...
              <a
                ...
                className="flex items-center gap-x-2 mt-4 md:mt-0">
                <button
                  ref={linkedinButtonRef}
                  className="px-3 py-2 border-2 border-stone-900 rounded-md hover:scale-110 bg-black text-white transition duration-300 ease-out hover:ease-in">
                  <div className="flex items-center gap-x-2">
